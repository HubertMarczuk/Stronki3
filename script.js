...
let btns_opponent = document.getElementsByClassName("button_opponent");
...
let fields = [field11,field12,field13,field21,field22,field23,field31,field32,field33];
let state = document.getElementById("state_text");
opponent = "human";
sign = "X";
game_mode = false;
...
function CheckResult(){
	if((field11.innerHTML == sign && field12.innerHTML == sign && field13.innerHTML == sign)
	 ||(field21.innerHTML == sign && field22.innerHTML == sign && field23.innerHTML == sign)
	 ||(field31.innerHTML == sign && field32.innerHTML == sign && field33.innerHTML == sign)
	 ||(field11.innerHTML == sign && field22.innerHTML == sign && field33.innerHTML == sign)
	 ||(field13.innerHTML == sign && field22.innerHTML == sign && field31.innerHTML == sign)
	 ||(field11.innerHTML == sign && field21.innerHTML == sign && field31.innerHTML == sign)
	 ||(field12.innerHTML == sign && field22.innerHTML == sign && field32.innerHTML == sign)
	 ||(field13.innerHTML == sign && field23.innerHTML == sign && field33.innerHTML == sign)
	){
		if(sign == "X"){
			if(opponent == "human"){
	...
	else if((field11.innerHTML == "X"|| field11.innerHTML == "O")
...
function Back(event){
	...
	field32.innerHTML = "";
	field33.innerHTML = "";
	fields = [field11,field12,field13,field21,field22,field23,field31,field32,field33]
}
